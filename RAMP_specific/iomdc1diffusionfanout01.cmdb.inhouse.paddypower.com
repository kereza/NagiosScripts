...
### $Id: twiddle.sh 112179 2011-08-31 05:45:27Z bmaxwell $ ###


DIRNAME=`dirname $0`
PROGNAME=`basename $0`
GREP="grep"
FILE=/opt/ops/scripts/jboss-admin/conf/jboss-ctl.conf
OPTION='\-p\S*|\-u\S*'

#
# Test if username and password have been supplied
# otherwise source them from $FILE
#

CREDENTIALS=`echo "$@" | grep -E -wo $OPTION`
...
exec "$JAVA" \
    ...
    org.jboss.console.twiddle.Twiddle  $AUTH "$@"